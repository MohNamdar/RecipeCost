...
- خروجی اکسل
- تشخیص خودکار ماده اولیه تکراری هنگام افزودن به رسپی و استفاده از ماده موجود
- کپی کامل محصول به همراه تمام رسپی و تنظیم سختی اختصاصی
- حالت روشن / تاریک با ذخیره انتخاب کاربر
